...
void Molecule<double_type>::calcMassActionConstant(const double temperature, const unsigned int grid_index)
{
  ...
  double_type log_K;
  double_type log_C, log_H, log_N, log_O;
...
- 2.547486398E+04/temperature -4.481917770E-01;
  ...
  log_K -= stoichometric_vector[index_C]*log_C + stoichometric_vector[index_H]*log_H + stoichometric_vector[index_N]*log_N + stoichometric_vector[index_O]*log_O;
